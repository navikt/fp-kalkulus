...
class AksjonspunktRepositoryTest extends EntityManagerAwareTest {
    ...
    public void skal_lagre_og_hente_aksjonspunkt() {
        ...
        assertThat(hentetAP.get().getDefinisjon()).isEqualTo(AksjonspunktDefinisjon.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS);
    }
