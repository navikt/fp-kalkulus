...
### Request
POST /aktivtBeregningsgrunnlag

Hentet aktivt beregningsgrunnlag for angitt behandling uavhening tilstand på grunnlaget
...
```json
{
  ...
  "grunnlagReferanse": "3fa85f64-5717-4562-b3fc-2c963f66afa6"
}
```
### Response
HTTP 200
