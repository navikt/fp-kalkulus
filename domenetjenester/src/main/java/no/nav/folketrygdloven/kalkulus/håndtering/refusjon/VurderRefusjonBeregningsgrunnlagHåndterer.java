...
public class VurderRefusjonBeregningsgrunnlagHåndterer implements BeregningHåndterer<VurderRefusjonBeregningsgrunnlagDto> {
    ...
    @Override
    public HåndteringResultat håndter(VurderRefusjonBeregningsgrunnlagDto dto, BeregningsgrunnlagInput beregningsgrunnlagInput) {
        BeregningsgrunnlagGrunnlagDto nyttGrunnlag = no.nav.folketrygdloven.kalkulator.KLASSER_MED_AVHENGIGHETER.aksjonspunkt.VurderRefusjonBeregningsgrunnlagHåndterer.håndter(mapVurderRefusjonBeregningsgrunnlagDto(dto), beregningsgrunnlagInput);
        OppdateringRespons endring = UtledEndring.utled(nyttGrunnlag, beregningsgrunnlagInput.hentForrigeBeregningsgrunnlagGrunnlag(BeregningsgrunnlagTilstand.VURDERT_REFUSJON_UT));
