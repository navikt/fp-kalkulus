...
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.FaktaOmBeregningTilfelleDtoTjeneste;
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.KortvarigeArbeidsforholdDtoTjeneste;
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.KunYtelseDtoTjeneste;
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.NyOppstartetFLDtoTjeneste;
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.VurderATFLISammeOrgDtoTjeneste;
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.VurderBesteberegningTilfelleDtoTjeneste;
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.VurderLønnsendringDtoTjeneste;
import no.nav.folketrygdloven.kalkulus.rest.tjenester.fakta.VurderMottarYtelseDtoTjeneste;
