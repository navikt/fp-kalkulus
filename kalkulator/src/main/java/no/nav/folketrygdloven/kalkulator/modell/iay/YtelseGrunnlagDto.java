...
public class YtelseGrunnlagDto {
    ...
    private List<YtelseStørrelseDto> ytelseStørrelse = new ArrayList<>();
    ...
    public YtelseGrunnlagDto(YtelseGrunnlagDto ytelseGrunnlag) {
        ...
        this.ytelseStørrelse = ytelseGrunnlag.getYtelseStørrelse().stream().map(ys -> {
            YtelseStørrelseDto ytelseStørrelse = new YtelseStørrelseDto(ys);
    ...
    void leggTilYtelseStørrelse(YtelseStørrelseDto ytelseStørrelse) {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (o == null || !(o instanceof YtelseGrunnlagDto))
            return false;
        YtelseGrunnlagDto that = (YtelseGrunnlagDto) o;
