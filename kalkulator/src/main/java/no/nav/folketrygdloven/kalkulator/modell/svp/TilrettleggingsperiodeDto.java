...
public class TilrettleggingsperiodeDto {

    private Arbeidsgiver arbeidsgiver;
    private UttakArbeidType uttakArbeidType;
    private List<PeriodeMedUtbetalingsgradDto> periodeMedUtbetalingsgrad;

    TilrettleggingsperiodeDto(Arbeidsgiver arbeidsgiver, UttakArbeidType uttakArbeidType, List<PeriodeMedUtbetalingsgradDto> periodeMedUtbetalingsgrad) {
