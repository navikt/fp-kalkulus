...
enum BeregningAksjonspunktDefinisjon implements Kodeverdi {
    ...
    AUTO_VENT_PÅ_MANGLENDE_ARBEIDSFORHOLD_KOMMUNEREFORM(
        BeregningAksjonspunktKodeDefinition.AUTO_VENT_PÅ_MANGLENDE_ARBEIDSFORHOLD_KOMMUNEREFORM_KODE,
        "Sak settes på vent pga kommune- og fylkesammenslåing."
    ),
    UNDEFINED,
    ;
