...
public class AksjonspunktutledertjenesteVurderRefusjonFP implements AksjonspunkutledertjenesteVurderRefusjon {

    @Inject
    public AksjonspunktutledertjenesteVurderRefusjonFP() {
    }
