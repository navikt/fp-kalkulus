...
public class AksjonspunktutledertjenesteVurderRefusjonFRISINN implements AksjonspunkutledertjenesteVurderRefusjon {

    @Inject
    public AksjonspunktutledertjenesteVurderRefusjonFRISINN() {
    }
