...
public class AvklaringsbehovutledertjenesteVurderRefusjonOMP implements AvklaringsbehovutledertjenesteVurderRefusjon {

    @Inject
    public AvklaringsbehovutledertjenesteVurderRefusjonOMP() {
    }
