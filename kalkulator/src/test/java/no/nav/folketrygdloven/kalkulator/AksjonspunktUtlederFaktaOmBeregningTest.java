...
public class AksjonspunktUtlederFaktaOmBeregningTest {
    ...
    public void skalUtledeAksjonspunktForSNNyIArbeidslivet() {
       ...
       var resultat = aksjonspunktUtlederFaktaOmBeregning.utledAksjonspunkterFor(input, grunnlag, false);

        // Assert
        assertThat(resultat.getBeregningAksjonspunktResultatList()).hasSize(1);
        assertThat(resultat.getBeregningAksjonspunktResultatList().get(0).getBeregningAksjonspunktDefinisjon()).isEqualTo(BeregningAksjonspunktDefinisjon.VURDER_FAKTA_FOR_ATFL_SN);
    ...
    public void skalUtledeAksjonspunktForFellesTilfeller() {
        ...
        BeregningsgrunnlagGrunnlagDto grunnlag = grunnlagBuilder.build(BeregningsgrunnlagTilstand.OPPDATERT_MED_ANDELER);
        var input = lagInput(iayGrunnlagBuilder);
        var resultater = aksjonspunktUtlederFaktaOmBeregning.utledAksjonspunkterFor(input, grunnlag, false);
    ...
    public void skalUtledeAksjonspunktForFellesTilfellerOgReturnereOverstyring() {
        ...
        BeregningsgrunnlagGrunnlagDto grunnlag = grunnlagBuilder.build(BeregningsgrunnlagTilstand.OPPDATERT_MED_ANDELER);
        var input = lagInput(iayGrunnlagBuilder);
        var resultater = aksjonspunktUtlederFaktaOmBeregning.utledAksjonspunkterFor(input, grunnlag, true);
    ...
    public void skalReturnereIngenAksjonspunkter() {
        ...
        // Assert
        assertThat(resultater.getBeregningAksjonspunktResultatList()).isEmpty();
    }
