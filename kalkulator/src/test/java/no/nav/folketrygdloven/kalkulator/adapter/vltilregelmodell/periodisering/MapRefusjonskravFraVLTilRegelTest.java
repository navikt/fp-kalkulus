...
public class MapRefusjonskravFraVLTilRegelTest {
    ...
    private void lagRefusjonoverstyring(Arbeidsgiver ag, InternArbeidsforholdRefDto ref, LocalDate dato) {
        ...
        BeregningRefusjonOverstyringDto overstyring = new BeregningRefusjonOverstyringDto(ag, null, Collections.emptyList(), Collections.singletonList(periodeOverstyring));
