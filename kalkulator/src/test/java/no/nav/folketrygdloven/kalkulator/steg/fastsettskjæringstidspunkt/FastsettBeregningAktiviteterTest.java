...
class FastsettBeregningAktiviteterTest {
    ...
    @Test
    void skal_ikke_inkludere_aktiviteter_som_starter_etter_skjæringstidspunkt() {
        // Arrange
        LocalDate ansettelsesDato = SKJÆRINGSTIDSPUNKT.plusDays(1);
        InntektArbeidYtelseGrunnlagDtoBuilder iayGrunnlagBuilder = lagIAY(ansettelsesDato, NULL_REF, Collections.emptyList());
        var opptjeningAktiviteterDto = lagOpptjeningsAktivitet(ansettelsesDato, NULL_REF);
    ...
    @Test
    void skal_inkludere_aktiviteter_som_starter_før_skjæringstidspunkt() {
        // Arrange
