...
class PeriodiserOgFastsettRefusjonTjenesteTest {
    ...
    public void skal_ikke_splitte_noe_hvis_refusjon_aggregat_er_tomt() {
        ...
        BeregningsgrunnlagDto resultat = PeriodiserOgFastsettRefusjonTjeneste.periodiserOgFastsett(grunnlagBuilder.build(), overstyringAggregatBuilder.build());
    ...
    public void skal_splitte_når_en_periode_med_en_andel_finnes_uten_refusjon() {
        lagBGPeriode(STP, null, lagBGAndel(AG1, REF1, 0));
        lagRefusjonOverstyring(AG1, lagStartdatoRef(REF1, dagerEtterSTP(10)));
    ...
    public void skal_ikke_splitte_når_dato_er_stp() {
        ...
        lagRefusjonOverstyring(AG1, lagStartdatoRef(REF1, STP));
    ...
    public void skal_legge_til_periodeårsak_når_splitt_finnes_fra_før() {
        ...
        lagRefusjonOverstyring(AG1, lagStartdatoRef(REF1, dagerEtterSTP(11)));
    ...
    public void skal_splitte_når_en_periode_med_to_andeler_finnes_kun_en_med_overstyring() {
        ...
        lagRefusjonOverstyring(AG2, lagStartdatoRef(REF2, dagerEtterSTP(15)));
    ...
    public void skal_splitte_grunnlag_når_3_perioder_finnes_fra_før_og_samme_ag_med_2_ref_overstyres() {
        ...
        lagRefusjonOverstyring(AG1, lagStartdatoRef(REF1, dagerEtterSTP(20)));
        lagRefusjonOverstyring(AG1, lagStartdatoRef(REF2, dagerEtterSTP(50)));
    ...
    public void skal_splitte_grunnlag_når_tilkommet_andel_søker_refusjon_og_splitt_skjer_samme_dag_som_annen_splitt() {
        ...
        lagRefusjonOverstyring(AG1, lagStartdatoRef(REF1, dagerEtterSTP(45)));
        lagRefusjonOverstyring(AG3, lagStartdatoRef(REF3, dagerEtterSTP(51)));
    ...
    private LocalDate dagerFørSTP(int i) {
    ...
    private void lagRefusjonOverstyring(Arbeidsgiver ag, BeregningRefusjonPeriodeDto...refusjonStart) {
        overstyringAggregatBuilder.leggTilOverstyring(new BeregningRefusjonOverstyringDto(ag, null, Arrays.asList(refusjonStart)));
    }

    private BeregningRefusjonPeriodeDto lagStartdatoRef(InternArbeidsforholdRefDto ref, LocalDate startdato) {
        return new BeregningRefusjonPeriodeDto(ref, startdato);
    }
