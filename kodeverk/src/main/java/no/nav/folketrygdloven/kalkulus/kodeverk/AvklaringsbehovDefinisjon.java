...
enum AvklaringsbehovDefinisjon implements Kodeverdi {
    ...
    VURDER_NYTT_INNTKTSFRHLD("VURDER_NYTT_INNTKTSFRHLD", MANUELL, BeregningSteg.FORDEL_BERGRUNN, "Vurder nytt inntektsforhold"),
    ...
    public static AvklaringsbehovDefinisjon fraKode(Object node) {
        ...
        var avklaringsbehovDefinisjon = KODER.get(kode);
        if (avklaringsbehovDefinisjon == null) {
