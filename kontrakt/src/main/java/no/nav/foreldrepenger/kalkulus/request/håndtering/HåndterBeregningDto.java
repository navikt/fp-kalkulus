package no.nav.foreldrepenger.kalkulus.request.håndtering;
...
import no.nav.foreldrepenger.kalkulus.request.håndtering.avklaraktiviteter.AvklarAktiviteterHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.fakta.FaktaOmBeregningHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.fordeling.FaktaOmFordelingHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.fordeling.VurderTilkommetInntektHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.foreslå.FastsettBGTidsbegrensetArbeidsforholdHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.foreslå.FastsettBeregningsgrunnlagATFLHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.foreslå.FastsettBeregningsgrunnlagSNNyIArbeidslivetHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.foreslå.VurderVarigEndretArbeidssituasjonHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.foreslå.VurderVarigEndringEllerNyoppstartetSNHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.overstyring.OverstyrBeregningsaktiviteterDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.overstyring.OverstyrBeregningsgrunnlagHåndteringDto;
import no.nav.foreldrepenger.kalkulus.request.håndtering.refusjon.VurderRefusjonBeregningsgrunnlagDto;
