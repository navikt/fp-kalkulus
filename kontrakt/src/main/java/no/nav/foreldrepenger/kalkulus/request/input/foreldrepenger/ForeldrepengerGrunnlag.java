package no.nav.foreldrepenger.kalkulus.request.input.foreldrepenger;
...
import no.nav.foreldrepenger.kalkulus.request.input.foreldrepenger.gradering.AktivitetGraderingDto;
import no.nav.foreldrepenger.kalkulus.request.input.YtelsespesifiktGrunnlagDto;
import no.nav.foreldrepenger.kalkulus.request.input.foreldrepenger.besteberegning.Ytelsegrunnlag;
