package no.nav.foreldrepenger.kalkulus.request.input.iay.v1;
...
import no.nav.foreldrepenger.kalkulus.request.input.iay.arbeid.v1.ArbeidDto;
import no.nav.foreldrepenger.kalkulus.request.input.iay.arbeid.v1.ArbeidsforholdInformasjonDto;
import no.nav.foreldrepenger.kalkulus.request.input.iay.inntekt.v1.InntekterDto;
import no.nav.foreldrepenger.kalkulus.request.input.iay.inntekt.v1.InntektsmeldingDto;
import no.nav.foreldrepenger.kalkulus.request.input.iay.inntekt.v1.InntektsmeldingerDto;
import no.nav.foreldrepenger.kalkulus.request.input.iay.ytelse.v1.YtelserDto;
import no.nav.foreldrepenger.kalkulus.request.input.iay.oppgitt.OppgittOpptjeningDto;
