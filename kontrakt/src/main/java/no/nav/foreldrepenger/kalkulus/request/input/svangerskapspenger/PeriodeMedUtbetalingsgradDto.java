package no.nav.foreldrepenger.kalkulus.request.input.svangerskapspenger;
...
import no.nav.foreldrepenger.kalkulus.typer.Aktivitetsgrad;
import no.nav.foreldrepenger.kalkulus.typer.Periode;
import no.nav.foreldrepenger.kalkulus.typer.Utbetalingsgrad;
