...
import no.nav.foreldrepenger.kalkulus.v1.avklaraktiviteter.AvklarAktiviteterHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.fakta.FaktaOmBeregningHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.fordeling.FaktaOmFordelingHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.fordeling.VurderTilkommetInntektHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.foreslå.FastsettBGTidsbegrensetArbeidsforholdHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.foreslå.FastsettBeregningsgrunnlagATFLHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.foreslå.FastsettBeregningsgrunnlagSNNyIArbeidslivetHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.foreslå.VurderVarigEndretArbeidssituasjonHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.foreslå.VurderVarigEndringEllerNyoppstartetSNHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.overstyring.OverstyrBeregningsaktiviteterDto;
import no.nav.foreldrepenger.kalkulus.v1.overstyring.OverstyrBeregningsgrunnlagHåndteringDto;
import no.nav.foreldrepenger.kalkulus.v1.refusjon.VurderRefusjonBeregningsgrunnlagDto;
