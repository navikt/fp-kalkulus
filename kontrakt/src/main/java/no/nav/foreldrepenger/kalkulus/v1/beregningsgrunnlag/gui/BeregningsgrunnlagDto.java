package no.nav.foreldrepenger.kalkulus.v1.beregningsgrunnlag.gui;
...
import no.nav.foreldrepenger.kalkulus.v1.Beløp;
import no.nav.foreldrepenger.kalkulus.v1.Periode;
import no.nav.folketrygdloven.kalkulus.kodeverk.AktivitetStatus;
import no.nav.folketrygdloven.kalkulus.kodeverk.Hjemmel;
import no.nav.foreldrepenger.kalkulus.v1.beregningsgrunnlag.gui.inntektsgrunnlag.InntektsgrunnlagDto;
import no.nav.foreldrepenger.kalkulus.v1.beregningsgrunnlag.gui.refusjon.RefusjonTilVurderingDto;
