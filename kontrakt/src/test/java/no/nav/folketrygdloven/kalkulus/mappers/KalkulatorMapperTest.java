...
public class KalkulatorMapperTest {
    ...
    private InntektArbeidYtelseGrunnlagDto byggIAY() {
        ...
        iayGrunnlag.medInntekterDto(new InntekterDto(List.of(new UtbetalingDto(InntektskildeType.INNTEKT_BEREGNING, List.of(new UtbetalingsPostDto(periode, InntektspostType.LØNN, DiffBeløp.fra(1000L)))))));
