...
alter table REGEL_SPORING_GRUNNLAG drop column if exists REGEL_INPUT;
alter table REGEL_SPORING_GRUNNLAG drop column if exists REGEL_EVALUERING;
...
where gr.aktiv = true and sporing.regel_input is not null
...
alter table REGEL_SPORING_PERIODE drop column if exists REGEL_INPUT;
alter table REGEL_SPORING_PERIODE drop column if exists REGEL_EVALUERING;
