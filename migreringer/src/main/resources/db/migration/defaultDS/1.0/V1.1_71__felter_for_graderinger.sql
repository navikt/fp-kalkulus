ALTER TABLE IF EXISTS BEREGNINGSGRUNNLAG_PERIODE ADD total_utbetalingsgrad_fra_uttak NUMERIC (19,4);
...
ALTER TABLE IF EXISTS BEREGNINGSGRUNNLAG_PERIODE ADD total_utbetalingsgrad_etter_reduksjon_ved_tilkommet_inntekt NUMERIC (19,4);
