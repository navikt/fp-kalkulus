...
create table if not exists  BG_PR_STATUS_OG_ANDEL(ID BIGINT NOT NULL,
                                                  ...
                                                  FASTSATT_AV_SAKSBEHANDLER VARCHAR(1) DEFAULT 'N'
);
...
alter table BEREGNINGSGRUNNLAG add constraint PK_BEREGNINGSGRUNNLAG primary key using index PK_BEREGNINGSGRUNNLAG;
create UNIQUE index PK_BG_AKTIVITET on BG_AKTIVITET (ID);
alter table BG_AKTIVITET add constraint PK_BG_AKTIVITET primary key using index PK_BG_AKTIVITET;
create UNIQUE index PK_BG_AKTIVITET_OVERSTYRINGER on BG_AKTIVITET_OVERSTYRINGER (ID);
alter table BG_AKTIVITET_OVERSTYRINGER add constraint PK_BG_AKTIVITET_OVERSTYRINGER primary key using index PK_BG_AKTIVITET_OVERSTYRINGER;
create UNIQUE index PK_BG_AKTIVITET_STATUS on BG_AKTIVITET_STATUS (ID);
alter table BG_AKTIVITET_STATUS add constraint PK_BG_AKTIVITET_STATUS primary key using index PK_BG_AKTIVITET_STATUS;
create UNIQUE index PK_BG_AKTIVITETER on BG_AKTIVITETER (ID);
alter table BG_AKTIVITETER add constraint PK_BG_AKTIVITETER primary key using index PK_BG_AKTIVITETER;
create UNIQUE index PK_BG_ANDEL_ARBEIDSFORHOLD on BG_ANDEL_ARBEIDSFORHOLD (ID);
alter table BG_ANDEL_ARBEIDSFORHOLD add constraint PK_BG_ANDEL_ARBEIDSFORHOLD primary key using index PK_BG_ANDEL_ARBEIDSFORHOLD;
create UNIQUE index PK_BG_ARBEIDSTAKER_ANDEL on BG_ARBEIDSTAKER_ANDEL (ID);
alter table BG_ARBEIDSTAKER_ANDEL add constraint PK_BG_ARBEIDSTAKER_ANDEL primary key using index PK_BG_ARBEIDSTAKER_ANDEL;
create UNIQUE index PK_BG_FAKTA_BER_TILFELLE on BG_FAKTA_BER_TILFELLE (ID);
alter table BG_FAKTA_BER_TILFELLE add constraint PK_BG_FAKTA_BER_TILFELLE primary key using index PK_BG_FAKTA_BER_TILFELLE;
create UNIQUE index PK_BG_FRILANS_ANDEL on BG_FRILANS_ANDEL (ID);
alter table BG_FRILANS_ANDEL add constraint PK_BG_FRILANS_ANDEL primary key using index PK_BG_FRILANS_ANDEL;
create UNIQUE index PK_BG_PERIODE on BEREGNINGSGRUNNLAG_PERIODE (ID);
alter table BEREGNINGSGRUNNLAG_PERIODE add constraint PK_BEREGNINGSGRUNNLAG_PERIODE primary key using index PK_BG_PERIODE;
create UNIQUE index PK_BG_PERIODE_AARSAK on BG_PERIODE_AARSAK (ID);
alter table BG_PERIODE_AARSAK add constraint PK_BG_PERIODE_AARSAK primary key using index PK_BG_PERIODE_AARSAK;
create UNIQUE index PK_BG_PERIODE_REGEL_SPORING on BG_PERIODE_REGEL_SPORING (ID);
alter table BG_PERIODE_REGEL_SPORING add constraint PK_BG_PERIODE_REGEL_SPORING primary key using index PK_BG_PERIODE_REGEL_SPORING;
create UNIQUE index PK_BG_PR_STATUS_OG_ANDEL on BG_PR_STATUS_OG_ANDEL (ID);
alter table BG_PR_STATUS_OG_ANDEL add constraint PK_BG_PR_STATUS_OG_ANDEL primary key using index PK_BG_PR_STATUS_OG_ANDEL;
create UNIQUE index PK_BG_REFUSJON_OVERSTYRINGER on BG_REFUSJON_OVERSTYRINGER (ID);
alter table BG_REFUSJON_OVERSTYRINGER add constraint PK_BG_REFUSJON_OVERSTYRINGER primary key using index PK_BG_REFUSJON_OVERSTYRINGER;
create UNIQUE index PK_BG_REGEL_SPORING on BG_REGEL_SPORING (ID);
alter table BG_REGEL_SPORING add constraint PK_BG_REGEL_SPORING primary key using index PK_BG_REGEL_SPORING;
create UNIQUE index PK_BG_SG_PR_STATUS on BG_SG_PR_STATUS (ID);
alter table BG_SG_PR_STATUS add constraint PK_BG_SG_PR_STATUS primary key using index PK_BG_SG_PR_STATUS;
create UNIQUE index PK_SAMMENLIGNINGSGRUNNLAG on SAMMENLIGNINGSGRUNNLAG (ID);
alter table SAMMENLIGNINGSGRUNNLAG add constraint PK_SAMMENLIGNINGSGRUNNLAG primary key using index PK_SAMMENLIGNINGSGRUNNLAG;
create UNIQUE index PK_GR_BEREGNINGSGRUNNLAG on GR_BEREGNINGSGRUNNLAG (ID);
alter table GR_BEREGNINGSGRUNNLAG add constraint PK_GR_BEREGNINGSGRUNNLAG primary key using index PK_GR_BEREGNINGSGRUNNLAG;
