...
public final class Databaseskjemainitialisering {
    ...
    static final String USER = "ftkalkulus_unit";
    ...
    private static HikariDataSource createDs(String user) {
        ...
        cfg.setJdbcUrl(System.getProperty("datasource.defaultDS.url", String.format("jdbc:postgresql://127.0.0.1:5433/%s?reWriteBatchedInserts=true", USER)));
