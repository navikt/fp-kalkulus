package no.nav.folketrygdloven.kalkulus.domene.felles.diff;
...
public class DiffResult {
    ...
    private TraverseGraph.TraverseResult result1;
    private TraverseGraph.TraverseResult result2;
    @SuppressWarnings("unused")
    private TraverseGraph traverser;

    public DiffResult(TraverseGraph traverser, TraverseGraph.TraverseResult result1, TraverseGraph.TraverseResult result2) {
