...
import static no.nav.folketrygdloven.kalkulus.domene.mapTilEntitet.KalkulatorTilBGMapper.mapAktivitetStatus;
import static no.nav.folketrygdloven.kalkulus.domene.mapTilEntitet.KalkulatorTilBGMapper.mapBeregningsgrunnlagPeriode;
import static no.nav.folketrygdloven.kalkulus.domene.mapTilEntitet.KalkulatorTilBGMapper.mapSammenligningsgrunnlagMedStatus;
import static no.nav.folketrygdloven.kalkulus.domene.mapTilEntitet.KalkulatorTilIAYMapper.mapArbeidsforholdRef;
import static no.nav.folketrygdloven.kalkulus.domene.mapTilEntitet.KalkulatorTilIAYMapper.mapArbeidsgiver;
