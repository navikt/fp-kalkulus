package no.nav.folketrygdloven.kalkulus.domene.periodisering;
...
import no.nav.folketrygdloven.kalkulator.adapter.vltilregelmodell.periodisering.InntektsmeldingForAndel;
