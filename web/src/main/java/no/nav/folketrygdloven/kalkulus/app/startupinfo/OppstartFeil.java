package no.nav.folketrygdloven.kalkulus.app.startupinfo;
...
interface OppstartFeil extends DeklarerteFeil {
    ...
    @TekniskFeil(feilkode = "FT-753407", feilmelding = "Uventet exception ved oppstart", logLevel = ERROR)
    Feil uventetExceptionVedOppstart(Exception e);

    @TekniskFeil(feilkode = "FT-753409", feilmelding = "Selftest %s: %s. Endpoint: %s. Responstid: %s. Feilmelding: %s.", logLevel = INFO)
